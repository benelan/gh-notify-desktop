...
A `gh` extension for displaying new GitHub notifications on your desktop.
...
Next, add the following line, which polls for and displays new notifications every two minutes:
...
When using the `-p` flag, only [participating notifications] will be displayed. For more usage information, see:
...
[participating notifications]: https://docs.github.com/en/get-started/learning-about-github/github-glossary#participating-notifications "GitHub glossary: participating notifications"
